...
class Simulator:
    ...
    def generate(self,):
        ...
        for index in range(self.iteration):
            ...
            for currentTime in range(0, self.simTime, 2):
                for startRow, startCol, launchingRate in startPositions:
                    ...
                    if succ:
                        ...
                        if len(trajectory) > abs(startRow - endRow) + abs(startCol - endCol) + 5:
                            print("wrong")
                            logging.info("wrong is ")
                            logging.info(len(trajectory))
...
if __name__ == '__main__':
    ...
    s = Simulator(startPointsNum=12, endPointsNum=12,iteration=1, row=32, column=32)
    s.generate()
